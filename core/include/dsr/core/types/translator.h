...
namespace DSR
{
    ...
    // Translators
    inline static IDL::MvregNode CRDTNode_to_IDL(uint32_t agent_id, uint64_t id, const mvreg<DSR::CRDTNode> &data)
    {
    ...
    inline static IDL::MvregEdgeAttr CRDTEdgeAttr_to_IDL(uint32_t agent_id, uint64_t id, uint64_t from, uint64_t to,
    ...
    inline static IDL::MvregNodeAttr CRDTNodeAttr_to_IDL(uint32_t agent_id, uint64_t id, uint64_t node,
