...
#ifndef _FAST_DDS_GENERATED_IDLGRAPH_H_
#define _FAST_DDS_GENERATED_IDLGRAPH_H_
...
private:
    ...
    std::array<float, 2> m_vec_float2{0.0};
    std::array<float, 3> m_vec_float3{0.0};
    std::array<float, 4> m_vec_float4{0.0};
    std::array<float, 6> m_vec_float6{0.0};
};
/*!
...
public:
    ...
    eProsima_user_DllExport bool operator<(const PairInt &rhs) const {
...
#endif // _FAST_DDS_GENERATED_IDLGRAPH_H_
