//
// Created by crivac on 17/01/19. Updated by JC, RC and PB
//
...
namespace CRDT
{
    ...
    class CRDTGraph : public QObject
    {
        ...
        public:
            ...
            void print_node(std::int32_t id)                        { utils->print_node(id);};
            void print_RT(const std::int32_t id)                    { utils->print_RT(id);};
