...
dsValuePubSubType::dsValuePubSubType()
{
    setName("dsValue");
    m_typeSize = static_cast<uint32_t>(dsValue::getMaxCdrSerializedSize()) + 4 /*encapsulation*/;
    m_isGetKeyDefined = dsValue::isKeyDefined();
    size_t keyLength = dsValue::getKeyMaxCdrSerializedSize()>16 ? dsValue::getKeyMaxCdrSerializedSize() : 16;
    m_keyBuffer = reinterpret_cast<unsigned char*>(malloc(keyLength));
    memset(m_keyBuffer, 0, keyLength);
}
...
bool dsValuePubSubType::serialize(void *data, SerializedPayload_t *payload)
{
    dsValue *p_type = static_cast<dsValue*>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->max_size); // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
            eprosima::fastcdr::Cdr::DDS_CDR); // Object that serializes the data.
    payload->encapsulation = ser.endianness() == eprosima::fastcdr::Cdr::BIG_ENDIANNESS ? CDR_BE : CDR_LE;
...
bool dsValuePubSubType::deserialize(SerializedPayload_t* payload, void* data)
{
    dsValue* p_type = static_cast<dsValue*>(data); //Convert DATA to pointer of your type
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(payload->data), payload->length); // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr deser(fastbuffer, eprosima::fastcdr::Cdr::DEFAULT_ENDIAN,
            eprosima::fastcdr::Cdr::DDS_CDR); // Object that deserializes the data.
    // Deserialize encapsulation.
...
std::function<uint32_t()> dsValuePubSubType::getSerializedSizeProvider(void* data)
{
    return [data]() -> uint32_t
    {
        return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<dsValue*>(data))) + 4 /*encapsulation*/;
    };
}

void* dsValuePubSubType::createData()
{
    return reinterpret_cast<void*>(new dsValue());
}

void dsValuePubSubType::deleteData(void* data)
{
    delete(reinterpret_cast<dsValue*>(data));
}

bool dsValuePubSubType::getKey(void *data, InstanceHandle_t* handle, bool force_md5)
{
    if(!m_isGetKeyDefined)
        return false;
    dsValue* p_type = static_cast<dsValue*>(data);
    eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(m_keyBuffer),dsValue::getKeyMaxCdrSerializedSize());     // Object that manages the raw buffer.
    eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS);     // Object that serializes the data.
    p_type->serializeKey(ser);
    if(force_md5 || dsValue::getKeyMaxCdrSerializedSize()>16)    {
        m_md5.init();
        m_md5.update(m_keyBuffer, static_cast<unsigned int>(ser.getSerializedDataLength()));
        m_md5.finalize();
        for(uint8_t i = 0;i<16;++i)        {
