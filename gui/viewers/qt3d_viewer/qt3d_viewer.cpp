...
namespace DSR {
    ...
    void QT3DViewer::update_edge_attr(uint64_t from, uint64_t to, const std::string& type, const std::vector<std::string> &att_names)
    {

    }


    void QT3DViewer::insert_node(const Node& node)
    {
        ...
        if (((x.has_value() && y.has_value() && z.has_value()) || path.has_value()) && mat.has_value()) {
            ...
            if (texture.has_value()) {
                ...
                if  (!str.empty()){
                    ...
                    {
                        qInfo() << "Other material. should load texture";
                    }
                } else {
            ...
            auto plane_mesh = [&](auto& x, auto& y, auto& z) {
                ...
                auto *planeMesh = new Qt3DRender::QGeometryRenderer(rootEntity);
    ...
    void QT3DViewer::update_node_attr(uint64_t id, const std::vector<std::string> &att_names)
    {
        //TODO
    }
