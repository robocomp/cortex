...
namespace DSR
{
    ...
    private:
        ...
        std::list<std::string> no_drawable_childs = {};
    ...
    public:
        ...
        QGraphicsItem *get_robot_polygon() const
        { return robot; };
    ...
    private:
        ...
        void add_or_assign_rect(Node &node, const std::string &color, const std::string &texture, int width, int height,
                                int depth);
        ...
        void
        draw_space(const std::string &name, const std::string &color_, int zvalue, Node &node, QGraphicsItem *parent);
